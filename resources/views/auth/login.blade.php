        ...
        <div class="p-8">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <input class="w-full border border-gray-300 rounded-lg py-2.5 px-3" id="email" type="email"
                        name="email">
                </div>

                <div class="mb-6">
                    <label class="block text-gray-700 text-sm font-semibold mb-2" for="password">Password</label>
                    <input class="w-full border border-gray-300 rounded-lg py-2.5 px-3" id="password" type="password"
                        name="password">
                </div>

                <button
                    class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg shadow-lg shadow-blue-500/30"
                    type="submit">
                    Sign In
                </button>
            </form>
